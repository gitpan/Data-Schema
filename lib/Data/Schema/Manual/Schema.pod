...
Data::Schema uses L<Data::PrefixMerge> to do the
merging. Data::PrefixMerge style of merging allows keys on the left
...
prefix C<^>. See L<Data::PrefixMerge> for more details on how merging
works.
